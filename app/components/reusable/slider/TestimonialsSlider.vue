...
const testimonials = ref([
  ...
  {
    text: "Thanks to VIP Leads, we doubled our qualified opportunities in less than 30 days. The ROI speaks for itself.",
    img: "/images/user.png",
    name: "Carlos G. ",
    title: "CEO",
  },
  {
    text: "What impressed me most was the accuracy. Every lead matched exactly the profile we were targeting. It saves both time and money.",
    img: "/images/user.png",
    name: "Emily R.",
    title: "Marketing Manager",
  },
  {
    text: "VIP Business Services helped us scale faster. Now we have a constant flow of high-value prospects.",
    img: "/images/user.png",
    name: "Andrés P.",
    title: "Business Development Lead",
  },
  {
    text: "We used to spend too much on campaigns without clear results. With VIP Leads, every dollar invested generates returns.",
    img: "/images/user.png",
    name: "Sofia V.",
    title: "Growth Manager",
  },
  {
    text: "VIP Leads helped us close more deals in one month than in the entire previous quarter. The lead quality is outstanding.",
    img: "/images/user.png",
    name: "Laura M.",
